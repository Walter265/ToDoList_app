    ...
    <head>
        ...
        <style>
            ...
            */
            ...
            .col .bg-body ul li:nth-child(even) {
                color:gray;
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="row" style="width: 800px;">
                <div class="col">
                    <div style="color: white;">   
                        ...
                        <form method="post" action="<?php echo e(route('markComplete', $listItem->id)); ?>" accept-charset="UTF-8" class="d-flex gap-2 mt-1">
                            ...
                            <li><?php echo e($listItem->name); ?></li>
                ...
                <div class="col">
                    <div class="p-3 p-3 bg-body text-center">
                        <ul>
                            ...
                            <li class="text-decoration-line-through text-breack"><?php echo e($item->name); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                </div>
...
<?php /**PATH C:\Users\USER\ToDoList_app\resources\views/welcome.blade.php ENDPATH**/ ?>